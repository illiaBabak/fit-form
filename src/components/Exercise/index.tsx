...
export const ExerciseItem = ({ exercise }: Props): JSX.Element => {
  return (
    <div className="bg-white flex flex-col items-center justify-center outline-black outline/10 shadow-md w-[220px] h-[220px] md:w-[300px] md:h-[300px] rounded-lg cursor-pointer duration-300 hover:scale-105 p-3 m-3">
      <img
